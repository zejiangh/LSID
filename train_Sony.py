...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default='/scratch/gpfs/zejiangh/Sony/Sony/short/')
    parser.add_argument('--gt_dir', type=str, default='/scratch/gpfs/zejiangh/Sony/Sony/long/')
